...
const Orders = () => {
  ...
  return (
    <div id="manage_orders_section" className="main_section p-4">
      <h4 className="text-center my-3 text-xl font-bold">مدیریت سفارشات</h4>
        ...
        <table className="min-w-full border border-gray-300 text-center rounded-lg shadow-sm">
          <thead className="bg-gray-200 text-gray-700">
            <tr>
              ...
              <th className="px-4 py-2 border">مبلغ پرداختی</th>
          ...
          <tbody>
            <tr className="hover:bg-gray-100">
              ...
              <td className="px-4 py-2 border">100هزار تومان</td>
              <td className="px-4 py-2 border">
                <i
                  className="fas fa-shopping-cart text-blue-500 mx-1 cursor-pointer"
                  title="جزئیات سفارش"
      ...
      {/* مودال‌ها */}
      {showAddOrder && (
        <AddOrder isOpen={showAddOrder} onClose={() => setShowAddOrder(false)} />
      )}
      {showOrderDetails && (
        <OrderDetails
