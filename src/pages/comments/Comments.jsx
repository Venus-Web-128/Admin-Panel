...
const Comments = () => {
  ...
  return (
    <div id="manage_comments_section" className="main_section p-4">
      <h4 className="text-center my-3 text-xl font-bold">مدیریت نظرات</h4>
        ...
        <table className="min-w-full border border-gray-300 text-center rounded-lg shadow-sm">
          <thead className="bg-gray-200 text-gray-700">
            <tr>
              ...
              <th className="px-4 py-2 border">نوع نظر</th>
          ...
          <tbody>
            <tr className="hover:bg-gray-100">
              ...
              <td className="px-4 py-2 border">نظر</td>
              <td className="px-4 py-2 border">محصول فلان</td>
              <td className="px-4 py-2 border">
                قسمتی از متن نظر برای این محصول مثلا 100 کارکتر
              </td>
              <td className="px-4 py-2 border">
